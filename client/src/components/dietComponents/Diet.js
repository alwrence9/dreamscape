...
function Diet() {
    ...
    <section id="diet-container">
      ...
      <ol>
        ...
        <li>Making water your drink of choice</li>
          ...
          Try “Meatless Monday” with this meatless recipe. Make an eating plan each week &hyphen; this is the key to fast, easy meal preparation.<br></br> 
  ...
  <p>Make most of your meal vegetables and fruits &hyphen; ½ of your plate. Aim for color and variety, and remember that potatoes don&apos;t count as vegetables on the Healthy Eating Plate because of their negative impact on blood sugar.</p>

  <h4>Go for whole grains &hyphen; ¼ of your plate.</h4>
  ...
  <h4>Protein power &hyphen; ¼ of your plate.</h4>
  ...
  <h4>Healthy plant oils &hyphen; in moderation.</h4>
    ...
    <div id="footer-content">
      ...
      <div id="sources">
        ...
        <div id="source-columns">
          <div id="source-col-1">
            <ul>
            <li>Heart & Stroke: <a target="_blank" rel="noreferrer" href="https://www.heartandstroke.ca/healthy-living/healthy-eating/healthy-eating-basics">Click</a></li>
            </ul>
          </div>
          <div id="source-col-2">
            <ul>
            <li>Harvard Nutrition: <a target="_blank" rel="noreferrer" href="https://www.hsph.harvard.edu/nutritionsource/healthy-eating-plate/">Click</a></li>
            </ul>
          </div>
          <div id="source-col-3">
            <ul>
